...
items_unpackable: Iterable[Item] = (
    ...
    Items.HiJump, Items.ChozenArmor, Items.Wave, Items.SpeedBooster, Items.Spazer,
    Items.Ice, Items.Grapple, Items.Plasma, Items.Evasion, Items.Charge,
    Items.SpaceJump, Items.Energy, Items.Artifact
)
